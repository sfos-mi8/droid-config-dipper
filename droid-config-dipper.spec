...
%define device dipper
%define vendor xiaomi

%define vendor_pretty Xiaomi
%define device_pretty Mi 8
...
%include patterns/patterns-sailfish-device-adaptation-dipper.inc
%include patterns/patterns-sailfish-device-configuration-dipper.inc
